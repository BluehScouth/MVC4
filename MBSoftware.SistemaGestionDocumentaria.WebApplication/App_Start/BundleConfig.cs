...
namespace MBSoftware.SistemaGestionDocumentaria.WebApplication
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/controller/mantenimiento").Include(
                  "~/Scripts/app/sgd/constantes.js",
                  "~/Scripts/app/sgd/controllers/baseController.js",
                       "~/Scripts/app/sgd/controllers/clienteController.js"));
