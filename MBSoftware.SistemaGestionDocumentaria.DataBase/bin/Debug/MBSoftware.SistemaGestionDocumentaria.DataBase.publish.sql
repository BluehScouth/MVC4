...
AS
Begin
	INSERT INTO Cliente(Nombre,Apellidos,Email,Telefono,Direccion)
...
AS
BEGIN
	SELECT ClienteId,Nombre,Apellidos,Email,Telefono,Direccion,PaisId FROM Cliente
END
GO
...
INSERT [dbo].[PARAMETROVALOR] ([CODIGOPARAMETRO], [CODIGOSECCION], [CODIGOVALOR], [VALOR], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 1, 1, N'001', N'A', N'ADMIN', CAST(0x0000AA3B00FB9732 AS DateTime), N'LOCAL', NULL, NULL, NULL)
...
INSERT [dbo].[PARAMETROVALOR] ([CODIGOPARAMETRO], [CODIGOSECCION], [CODIGOVALOR], [VALOR], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 1, 2, N'002', N'A', N'ADMIN', CAST(0x0000AA3B00FB9732 AS DateTime), N'LOCAL', NULL, NULL, NULL)
...
INSERT [dbo].[PARAMETROVALOR] ([CODIGOPARAMETRO], [CODIGOSECCION], [CODIGOVALOR], [VALOR], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 1, 3, N'003', N'A', N'ADMIN', CAST(0x0000AA3B00FB9732 AS DateTime), N'LOCAL', NULL, NULL, NULL)
...
INSERT [dbo].[PARAMETROVALOR] ([CODIGOPARAMETRO], [CODIGOSECCION], [CODIGOVALOR], [VALOR], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 1, 4, N'004', N'A', N'ADMIN', CAST(0x0000AA3B00FB9732 AS DateTime), N'LOCAL', NULL, NULL, NULL)
