...
INSERT [dbo].[PARAMETROSECCION] ([CODIGOPARAMETRO], [CODIGOSECCION], [NOMBRE], [SOLOLECTURA], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 1, N'Codigo', 1, N'A', N'ADMIN', CAST(0x0000AA3B00FA797E AS DateTime), N'LOCAL', NULL, NULL, NULL)
INSERT [dbo].[PARAMETROSECCION] ([CODIGOPARAMETRO], [CODIGOSECCION], [NOMBRE], [SOLOLECTURA], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (1, 2, N'Descripcion', 1, N'A', N'ADMIN', CAST(0x0000AA3B00FA797E AS DateTime), N'LOCAL', NULL, NULL, NULL)

INSERT [dbo].[PARAMETROSECCION] ([CODIGOPARAMETRO], [CODIGOSECCION], [NOMBRE], [SOLOLECTURA], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (2, 3, N'Codigo', 1, N'A', N'ADMIN', CAST(0x0000AA3B00FA797E AS DateTime), N'LOCAL', NULL, NULL, NULL)
INSERT [dbo].[PARAMETROSECCION] ([CODIGOPARAMETRO], [CODIGOSECCION], [NOMBRE], [SOLOLECTURA], [ESTADOREGISTRO], [USUARIOCREACION], [FECHACREACION], [TERMINALCREACION], [USUARIOMODIFICACION], [FECHAMODIFICACION], [TERMINALMODIFICACION]) VALUES (2, 4, N'Descripcion', 1, N'A', N'ADMIN', CAST(0x0000AA3B00FA797E AS DateTime), N'LOCAL', NULL, NULL, NULL)
