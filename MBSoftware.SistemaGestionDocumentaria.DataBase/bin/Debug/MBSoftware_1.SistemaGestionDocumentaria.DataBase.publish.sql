...
AS
Begin
	INSERT INTO Cliente(Nombre,Apellidos,Email,Telefono,Direccion,CodigoPais,CodigoDocumento)
	values (@Nombre,@Apellidos,@Email,@Telefono,@Direccion,@CodigoPais,@CodigoDocumento)
...
AS
BEGIN
	SELECT ClienteId,Nombre,Apellidos,Email,Telefono,Direccion,CodigoPais,CodigoDocumento  FROM Cliente
END
GO
